...
pub const BITS_SUBTRACTS: &[u8] = b"\x20\x03\x00\x00\x40\x06\x00\x00\x8C\x0A\x00\x00\xA0\x0F\x00\x00\x70\x17\x00\x00\x1C\x22\x00\x00\xEC\x2C\x00\x00\xDC\x44\x00\x00\xC0\x5D\x00\x00\x00\x7D\x00\x00";
pub const AUCTION_COUNT: usize = 16;
pub const OINKMON_AUCTION_IDX: usize = 15;
